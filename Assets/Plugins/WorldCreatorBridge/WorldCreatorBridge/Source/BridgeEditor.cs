...
namespace BtB.WC.Bridge
{
        ...
        public class BridgeEditor : EditorWindow, IHasCustomMenu
    {
        ...
        private static string FolderPath => BtB.WC.Bridge.PathProvider.GetDirectoryPath();
        ...
        {
            LoadSettings();
            _folderPath = PathProvider.GetDirectoryPath();
        }

        #region Settings

        private string GetSettingsDirectory() //работаем тут
        {
            return _folderPath + @"/Settings";
            //AssetDatabase.FindAssets("t:WCDirectoryPathData");
        ...
        {
            string spritesFolder = _folderPath + "/Content/Sprites/";
            //string spritesFolder = @"Assets/Plugins/WorldCreatorBridge/WorldCreatorBridge/Content/Sprites/"; //о для теста
        ...
        public static void Init()
        {
            ...
            Window.titleContent = new GUIContent("World Creator Bridge", AssetDatabase.LoadAssetAtPath<Texture2D>(FolderPath + "/Content/Sprites/" + (EditorGUIUtility.isProSkin ? "icon_wc.png" : "icon_wc_inv.png")));
            Window.Show();
        }
